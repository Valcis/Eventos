...
import type {Gasto, Precio} from './shared/types';

export interface Preset<Row> {
    /** Columnas */
    columnsDetailed: Array<ColumnDef<Row>>;
    columnsSimple?: Array<ColumnDef<Row>>; // si no se pasa, se infiere por isSimpleKey
    ...
    /** Esquema de formulario de creación/edición (stub para que lo conectes) */
    formSchema?: Array<{
        id: keyof Row | string;
        label: string;
