...
export function calcularTotalPedido(reserva: Pick<Reserva, 'parrilladas' | 'picarones'>, precios: Precio[]): number {
...
export function reservasConfirmadas(reservas: Reserva[]): { parrilladas: number; picarones: number } {
