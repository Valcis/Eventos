    ...
    return (
        ...
        >
            ...
            <div className="relative z-[9999] w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-black/10">
                <h2 id="alert-title" className="text-lg font-semibold text-gray-900">{title}</h2>
                {description ? <p id="alert-desc" className="mt-2 text-sm text-gray-600">{description}</p> : null}
